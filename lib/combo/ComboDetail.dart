...
class _ProductDetailState extends State<ComboDetail>
  ...
  ComboDetailItem? comboDetailItem;
  ...
  //       .isNotEmpty) {
  //     audioFiles.add(
  //       comboDetailResponse!.comboDetail.elementAt(0).productAudioEnglish,
  //     );
  ...
  //       .isNotEmpty) {
  //     audioFiles.add(
  //       comboDetailResponse!.comboDetail.elementAt(0).productAudioHindi,
  //     );
  ...
  //       .isNotEmpty) {
  //     audioFiles.add(
  //       comboDetailResponse!.comboDetail.elementAt(0).productAudioGujarati,
  //     );
