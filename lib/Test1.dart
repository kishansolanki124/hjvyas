        ...
        children: [
          ...
          AnimatedBuilder(
            ...
            builder: (context, child) {
              ...
              if (_isFirstLoad && _animationController.status == AnimationStatus.completed) {
              ...
              return PageView.builder(
                ...
                physics: _isFirstLoad ? NeverScrollableScrollPhysics() : CustomBouncePhysics(),
                onPageChanged: (index) {
                  if (!_isFirstLoad) {
  ...
  Simulation? createBallisticSimulation(ScrollMetrics position, double velocity) {
    ...
    if (position.outOfRange) {
      ...
      return BouncingScrollSimulation(
        ...
        velocity: velocity * 0.9, // Slightly reduce velocity for control
